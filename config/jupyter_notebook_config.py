...
if 'allow_password_change' in os.environ:
  if os.environ['allow_password_change'] == "False":
    allow_password_change = False;

passwd_env = passwd('demo')
if 'PASSWORD' in os.environ:
  passwd_env = passwd(os.environ['PASSWORD']);
...
c.NotebookApp.allow_password_change = allow_password_change
...
c.NotebookApp.password = passwd_env;
